...
parser.add_option("--system",dest="system",default="eager")
parser.add_option("--explore",dest="explore_policy",default='none')
parser.add_option("--dep",dest="add_dep_label",action="store_true",default=False)

parser.add_option("-t","--train",dest="train",action="store_true",default=False)
